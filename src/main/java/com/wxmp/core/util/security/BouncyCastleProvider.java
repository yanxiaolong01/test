...
public class BouncyCastleProvider extends Provider {
    ...
    public BouncyCastleProvider() {
        ...
        */
        ...
        put("Alg.Alias.Mac.HMAC/MD4", "HMACMD4");
        put("Mac.HMACMD5", "org.bouncycastle.jce.provider.JCEMac$MD5Util");
        put("Alg.Alias.Mac.HMAC-MD5Util", "HMACMD5");
        put("Alg.Alias.Mac.HMAC/MD5Util", "HMACMD5");
        ...
        put("MessageDigest.MD5Util", "org.bouncycastle.jce.provider.JDKMessageDigest$MD5Util");
        put("MessageDigest.1.2.840.113549.2.5",
            "org.bouncycastle.jce.provider.JDKMessageDigest$MD5Util");
        ...
        put("Alg.Alias.Signature.MD5withRSA", "MD5WithRSAEncryption");
        put("Alg.Alias.Signature.MD5Util/RSA", "MD5WithRSAEncryption");
